...
CREATE TABLE airlines (
  id SERIAL UNIQUE ,
  airline TEXT NOT NULL UNIQUE PRIMARY KEY
);
...
('2018-04-08 09:00:00', '2018-04-08 12:00:00', 'United', 'Washington DC', 'United States', 'Seattle', 'United States'),
  ...
  ( '2019-01-20 19:30:00', '2019-01-20 22:45:00', 'American Airlines', 'Sao Paolo', 'Brazil', 'Santiago', 'Chile');

INSERT INTO passengers_flights 
(passenger_id, flight_id, seat) VALUES 
  (1, 1, '33B'),
  (2, 7,'8A'),
  (5, 7,'12F'),
  (8,6,'20A'),
